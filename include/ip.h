...
{
    eth_begin_dma_send((uint8_t *)frame + sizeof(frame_meta_t), frame->meta.len);
}
...
static inline ipv4_addr_t ipv4_unspecified()
{
    return make_ipv4(0);
}

static inline ipv4_addr_t ipv4_broadcast()
{
    return make_ipv4(0xffffffff);
}

static inline ipv6_addr_t ipv6_unspecified()
{
    return make_ipv6(0, 0);
}
...
static inline bool ipv4_is_unspecified(ipv4_addr_t a)
{
    return a.u32 == 0;
}
